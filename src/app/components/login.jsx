                ...
                <div className="w-full max-w-sm">
                    ...
                    <div className="space-y-6">
                        ...
                        <form className="space-y-6">
                            ...
                            <button
                                type="submit"
                                className="w-full rounded-md border border-transparent  py-2 px-4 text-sm font-medium text-black shadow-sm  focus:outline-none focus:ring-2  focus:ring-offset-2" onClick={() => router.push('/sign-up')}
                            >
                                Sign Up
                            </button>
                        </form>
